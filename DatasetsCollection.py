...
TRANSFORMED_FOLDS_PATH = os.path.join(os.path.dirname(__file__), 'folds_transformed')
...
def load(name, url=None, encode_features=True, remove_metadata=True, scale=True, noise_level=0.0, transformed=False):
